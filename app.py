...
def home():
    return (f"Welcome to Surf's Up!: Hawai'i Climate API<br/>"
            ...
            f"/api/v1.0/2017-08-01  ~~~~~~~~~~~ low, high, and average temp for date given and each date after<br/>"
            f"/api/v1.0/2017-08-01/2017-08-11 ~~ low, high, and average temp for date given and each date up to and including enddate<br/>"
            f"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~<br/>"
